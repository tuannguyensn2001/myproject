...
$course=[];
$count=0;
for($i=0;$i<count($data['course']);$i+=2){
    $count++;
   $course[$count][0]=$data['course'][$i];
   if (isset($data['course'][$i+1]))  $course[$count][1]=$data['course'][$i+1];
}
...
<body>
    ...
    <div class="container content">
        <div class="content-videos">
            ...
            <?php foreach (($data['post']) as $index){ ?>
                <a href="PostController/viewPost/<?=$index['id']?>">
