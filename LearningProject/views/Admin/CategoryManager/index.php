...
<body>
        ...
        <div id="content">
            ...
            <?php if (isset($_COOKIE['failed_admin'])){ ?>
                <div class="alert alert-danger" role="alert" >
                  Bạn không có quyền thêm mới danh mục
                </div>
            <?php } ?>
            <?php if (isset($_COOKIE['failed_admin1'])){ ?>
                <div class="alert alert-danger" role="alert" >
            ...
            <table class="table table-striped table-dark">
                ...
                <tr>
                    ...
                    <th scope="col"><a href="" class="btn btn-primary addCategory" data-toggle="modal" data-target="#exampleModal">Thêm mới</a></th>
                </tr>
                </thead>
                <tbody>
                <?php foreach ($data['listCategory'] as $index){ ?>
                    <tr>
                        ...
                        <td ><button class="btn btn-primary view-details" content="<?=$index['id']?>" data-toggle="modal" data-target="#exampleModal"><i class='fas fa-eye ' style='font-size:24px'  ></i></button>
                            <a href="deleteCategory/<?=$index['id']?>" class="btn btn-danger">XÓA</a>
                        </td>
    ...
    <script >
        ...
        $(".view-details").click(function () {
            ...
            $(".modal-title").html("Chỉnh sửa  danh mục");
            $(".modal form").attr("action","editCategory");
               $.ajax({
                   type:"POST",
                   url: "showCategory",
                   data:{
        ...
        $(".addCategory").click(function (event) {
            ...
            $(".modal form").attr("action","addCategory");
