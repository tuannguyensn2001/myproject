                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="archive-catagory-view mb-50 d-flex align-items-center justify-content-between">
                        ...
                        <div class="view-options">
                            ...
                            <a href="archive-list.php?id=<?=$category_id?>"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="single-post.php?id=<?=$posts[$i]['id']?>&category=<?=$posts[$i]['category']?>" class="post-title"><?=$posts[$i]['title']?> </a>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <img src="<?=$posts[$k]['thumbnail']?>" alt="" height=300>
                                ...
                                <div class="post-content">
                                    <a href="#" class="post-cata cata-sm cata-success"><?=$category?></a>
                                    <a href="single-post.php?id=<?=$posts[$k]['id']?>&category=<?=$posts[$k]['category']?>" class="post-title"><?=$posts[$k]['title']?></a>
                    ...
                    <nav class="mt-50">
                        <ul class="pagination justify-content-center">
                            ...
                            ?>
                            <?php if ($i == 1) {?>
                                 <li class="page-item"><a class="page-link" href="archive-grid.php?id=<?=$category_id?>">1</a></li>
                            <?php } else { ?>
                                <li class="page-item"><a class="page-link" href="archive-grid-pagination.php?id=<?=$category_id?>&pagid=<?=$i?>"><?=$i?></a></li>
                            <?php } ?>
                            <?php
                            }
